...
class MCTS:
    ...
    def obtener_distribuciones_batch(self, nodos):
        ...
        # Medir saturación de la cola
        #if self.request_model_queue.qsize() > 1:
        #    print(
        #        f"[Worker {self.worker_id}] ⚠️ Cola de inferencia saturada con {self.request_model_queue.qsize()} elementos")
