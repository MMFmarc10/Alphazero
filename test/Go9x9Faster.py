...
class Go9x9Faster(BaseGame):
    ...
    def __init__(self):
        ...
        if not Go9x9Faster.neighbor_table:
            Go9x9Faster.neighbor_table = self._build_neighbor_table()
        ...
        for nr, nc in neighbors:
            if self.board[nr, nc] == self.player:
                ...
                if gid not in group_dict:
                    print("proooooooooobleeem")
                    continue  # O loguear un warning si esto no debería pasar
    ...
    def get_neighbors(self, r, c):
        return Go9x9Faster.neighbor_table[(r, c)]
