...
from games.Group import Group



class Go9x9Fast(BaseGame):
    ...
    def get_neighbors(self, r, c):
        return Go9x9Fast.neighbor_table[(r, c)]
...
Go9x9Fast.neighbor_table = {
    (r, c): [(r + dr, c + dc) for dr, dc in [(-1, 0), (1, 0), (0, -1), (0, 1)]
             if 0 <= r + dr < Go9x9Fast.SIZE and 0 <= c + dc < Go9x9Fast.SIZE]
    for r in range(Go9x9Fast.SIZE)
    for c in range(Go9x9Fast.SIZE)
}
