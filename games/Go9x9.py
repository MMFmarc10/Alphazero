...
class Go9x9(BaseGame):
    ...
    def __init__(self):
        ...
        if not Go9x9.neighbor_table:
            Go9x9.neighbor_table = self._build_neighbor_table()
    ...
    def encode_board(self, history_length=3):
        """
    ...
    def get_neighbors(self, r, c):
        return Go9x9.neighbor_table[(r, c)]
